...
/*  37 "./src/unit_struct.h" */
    ...
    int_least8_t mem_int_least8_t;
    uint_least8_t mem_uint_least8_t;

    intptr_t mem_intptr_t;
    uintptr_t mem_uintptr_t;
/*  106 "./src/unit_struct.h" */
    SYSLOG mem_SYSLOG;
    T_SYSLOG_RLOG mem_T_SYSLOG_RLOG;
/*  121 "./src/unit_struct.h" */
    TEXPTN mem_TEXPTN;
    FLGPTN mem_FLGPTN;
    OVRTIM mem_OVRTIM;
    INTNO mem_INTNO;
...
/*  141 "./src/unit_struct.h" */
    ...
    T_ROVR mem_T_ROVR;
    T_CISR mem_T_CISR;
/*  217 "./src/unit_struct.h" */
    button_t mem_button_t;




    memfile_t mem_memfile_t;
    fileinfo_t mem_fileinfo_t;
    ...
    lcdfont_t mem_lcdfont_t;
    lcdcolor_t mem_lcdcolor_t;
    image_t mem_image_t;




    ledcolor_t mem_ledcolor_t;
/*  262 "./src/unit_struct.h" */
    colorid_t mem_colorid_t;
    rgb_raw_t mem_rgb_raw_t;
/*  282 "./src/unit_struct.h" */
    TCHAR mem_TCHAR;
...
/*  401 "./src/unit_struct.h" */
    ...
    intptr_t mem_intptr_t;
    uintptr_t mem_uintptr_t;
/*  470 "./src/unit_struct.h" */
    SYSLOG mem_SYSLOG;
    T_SYSLOG_RLOG mem_T_SYSLOG_RLOG;
/*  485 "./src/unit_struct.h" */
    TEXPTN mem_TEXPTN;
    FLGPTN mem_FLGPTN;
    OVRTIM mem_OVRTIM;
    INTNO mem_INTNO;
...
/*  581 "./src/unit_struct.h" */
    ...
    ledcolor_t mem_ledcolor_t;
/*  626 "./src/unit_struct.h" */
    colorid_t mem_colorid_t;
    rgb_raw_t mem_rgb_raw_t;
/*  646 "./src/unit_struct.h" */
    TCHAR mem_TCHAR;
    TCHAR mem_TCHAR_buf[256];
